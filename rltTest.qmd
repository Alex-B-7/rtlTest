...
-   You can do this manually by just creating a new folder, or from the command line using this code:
...
-   If you open the bare remote repository you will see a bunch of metadata files and not the files that are in your R project
    ...
    ![](images/Screenshot%202024-08-26%20at%202.21.15%20PM.png)
...
![](images/Screenshot%202024-08-26%20at%202.26.35%20PM.png)
